    ...
    if (isErrorKernel) {
        return (
            <NoData
                ...
                description="Unable to load required data such as users. Please try again later."
        ...
        return (
            <div className="p-6 bg-white rounded-xl shadow-sm min-h-screen">
                <PageHeader
                    ...
                    onCreate={() => OnCreate(1)}
                    createLabel="Add Planning Series"
                />
                ...
                <NoData
                    title="No Planning Series Found"
                    description="Adjust your filters or create a new planning series."
    ...
    return (
        <div className="p-6 bg-white rounded-xl shadow-sm min-h-screen">
            ...
            <DataTable
                ...
                useGetBuyProductDetailsQuery={useGetPlanningSeriesDetailsQuery}
