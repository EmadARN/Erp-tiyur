...
import { useGetPoultryCuttingReturnDetailsQuery } from "../api/poultryCuttingReturnApi";
...
import { usePoultryCuttingReturnData } from "../hooks/usePoultryCuttingReturnData";
