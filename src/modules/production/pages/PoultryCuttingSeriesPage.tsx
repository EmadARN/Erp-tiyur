  ...
  if (isErrorKernel) {
    return (
      <NoData
        ...
        description="نمی‌توان داده‌های مورد نیاز مانند صاحبان محصول یا کاربران را بارگذاری کرد. لطفاً بعداً دوباره امتحان کنید."
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <CreateDialog
        ...
        customMessage={
          isKernelDataEmpty
            ? "نمی‌توان سری تولید جدیدی ایجاد کرد زیرا داده‌های ضروری (مانند صاحبان محصول) وجود ندارد."
            : undefined
        }
        isConfirmDisabled={isKernelDataEmpty}
      />
