...
export function getCreateDialogConfigs({ products, product_owners, receiver_delivery_units, users, statuses }: KernelData): ConfigItem[] {
    return [
        {
...
export function getUpdateDialogConfigs({ products, product_owners, receiver_delivery_units, users, statuses }: KernelData): ConfigItem[] {
    return [
        {
            name: "product.product",
            label: "محصول",
