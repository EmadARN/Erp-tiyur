...
import type { LoadedProduct, FiltersRecord, LoadedProductsResponse } from "../model/loadedProductTypes";
import { tableHead } from "../model/loadedProductIndex";
...
export const useLoadedProductData = () => {
  ...
  const { data: items, isLoading } = useGetLoadedProductsQuery(paramsFilterData, {
