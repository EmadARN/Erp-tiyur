export interface CarInfo {
  ...
  export interface LoadedProduct {
    product: { product: string; product_owner: string };
  ...
  export interface LoadedProductItem {
    id: string;
    weight: number;
    number: number;
    loaded_product: LoadedProduct;
  }
  
  export interface CreateLoadedProductItemDto extends LoadedProductItem {}
