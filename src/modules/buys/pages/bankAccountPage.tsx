...
const BankAccountPage = () => {
    ...
    const { accounts, isLoading, filterData, setFilterData, handleFilterOnChange, handleSearch } = useBankAccountData();
    const { deleteHandler, bulkDeleteHandler, handleCreateConfirm, handleUpdateConfirm } = useBankAccountActions();
    ...
    if (!accounts?.data || accounts.data.length === 0) {
        return (
            ...
            <PageHeader title="Bank Accounts" breadcrumbItems={breadcrumbItems} onCreate={() => setCreateIndex(1)} createLabel="Add Bank Account" />
        ...
        <FiFilter className="mr-2" /> Filters
            ...
            <NoData title="No bank accounts found" description="Try adjusting filters or create a new bank account." icon={<FiCreditCard className="w-12 h-12 text-blue-500" />} />
