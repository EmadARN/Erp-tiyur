...
import { useGetdriversDetailsQuery } from "../api/DriverApi.ts";
...
import { usedriverData } from "../hooks/useDriverData.ts";
import { usedriverActions } from "../hooks/useDriverActions.ts";
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <DataTable
        ...
        useGetBuyProductDetailsQuery={useGetdriversDetailsQuery}
