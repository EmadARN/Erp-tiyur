...
import { useGetusersDetailsQuery } from "../api/userApi.ts";
...
const user = () => {
  ...
  const isKernelDataEmpty = !kernelData?.roles.length;
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <DataTable
        ...
        useGetBuyProductDetailsQuery={useGetusersDetailsQuery}
