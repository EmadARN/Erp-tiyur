...
import { useGetContactsDetailsQuery } from "../api/ContactApi.ts";
...
import { useContactData } from "../hooks/useContactData.ts";
...
const Contact = () => {
  ...
  const isKernelDataEmpty = !kernelData.units.length;
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <DataTable
        ...
        useGetBuyProductDetailsQuery={useGetContactsDetailsQuery}
