...
import { useGetproductOwnersDetailsQuery } from "../api/productOwnerApi.ts";
...
import {
  ...
  tableFilter,
  tableHead,
} from "../model/productOwnerIndex.ts";
...
import { useproductOwnerData } from "../hooks/useProductOwnerData.ts";
import { useproductOwnerActions } from "../hooks/useProductOwnerActions.ts";
...
const productOwner = () => {
  ...
  const isKernelDataEmpty = !kernelData?.contacts.length;
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <DataTable
        ...
        useGetBuyProductDetailsQuery={useGetproductOwnersDetailsQuery}
