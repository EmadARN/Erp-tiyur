...
import { useGetproductCategorysDetailsQuery } from "../api/productCategoryApi.ts";
...
import {
  ...
  tableFilter,
  tableHead,
} from "../model/productCategoryIndex.ts";
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-white rounded-xl shadow-sm min-h-screen">
      ...
      <DataTable
        ...
        useGetBuyProductDetailsQuery={useGetproductCategorysDetailsQuery}
