...
type FilterItem = {
  label: string;
  type: "range" | "autocomplete" | "select-box" | "switch" | "multi-select" | "range-box";
  name: string;
  options?: any[];
  placeholder?: string;
...
export const DynamicFilters = ({ filtersConfig, data, setData }: DynamicFiltersProps) => {
              ...
              return (
                  <div key={filter.name}>
                    ...
                    <Slider
                        ...
                        onChange={(val) => handleChange(filter.name, val, filter.type)}
                    />
                  </div>
              );
              ...
              return (
                  <div key={filter.name}>
                    ...
                    <AutoComplete
                        ...
                        onSelect={(val) => handleChange(filter.name, val, filter.type)}
              ...
              return (
                  <div key={filter.name}>
                    <InputRangeBox
                        ...
                        valueFrom={value[0]}
                        valueTo={value[1]}
                        onChangeFrom={(val) => handleChange(filter.name, [val, value[1]], filter.type)}
                        onChangeTo={(val) => handleChange(filter.name, [value[0], val], filter.type)}
                    />
                  </div>
              );
