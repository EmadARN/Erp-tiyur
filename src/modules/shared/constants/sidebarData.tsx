...
export const treeData = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Series",
        icon: <FaFile />,
        path: "/dashboard/production/series",
      },
      {
        id: "1.3",
        label: "Export",
        icon: <FaFile />,
        path: "/dashboard/production/export",
      },
      {
        id: "1.4",
        label: "Import By Car",
        icon: <FaFile />,
        path: "/dashboard/production/import-by-car",
      },
      {
        id: "1.5",
      ...
      },
      {
        ...
        icon: <FaFile />,
        path: "/dashboard/production/return-product",
      },
      {
        id: "1.7",
        label: "Planning Cell",
        icon: <FaFile />,
        path: "/dashboard/planning/cell",
      },
      {
        id: "1.8",
        label: "Planning Series",
        icon: <FaFile />,
        path: "/dashboard/planning/series",
      },
      {
        id: "1.9",
